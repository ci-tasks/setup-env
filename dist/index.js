...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield (0, setup_1.setup)({ path, mask, expr });
        }
        catch (error) {
...
const core = __importStar(__nccwpck_require__(186));
function setup({ path, mask, expr }) {
    return __awaiter(this, void 0, void 0, function* () {
        // eslint-disable-next-line @typescript-eslint/no-require-imports
        const dotenv = (__nccwpck_require__(437).config)({ path }); // eslint-disable-line @typescript-eslint/no-var-requires
        // eslint-disable-next-line @typescript-eslint/no-require-imports
        const dotexp = (__nccwpck_require__(967).expand)(dotenv); // eslint-disable-line @typescript-eslint/no-var-requires
